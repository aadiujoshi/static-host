...
const __injectCanvas = () => {
	...
	let div = document.getElementById("animate-one-dynamic-sketch-container") as HTMLDivElement | null;
	let canvas = document.getElementById("animate-one-dynamic-sketch-canvas") as HTMLCanvasElement | null;
