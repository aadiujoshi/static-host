if(typeof window !== 'undefined' && typeof window.document !== 'undefined') {
    function sketchEnvironmentIsRunning(targetSketchId){
        return self.AnimateOneEnvironment.sketches[targetSketchId].running;
    }

    function startSketchEnvironment(targetSketchId) {
        self.AnimateOneEnvironment.sketches[targetSketchId].running = true;
    }

    function stopSketchEnvironment(targetSketchId) {
        self.AnimateOneEnvironment.sketches[targetSketchId].running = false;
    }

    //context has to already have been initialized
    function exposeSketchEnvironment(targetSketchId, context) {
        self.AnimateOneEnvironment.sketches[targetSketchId].context = context;
    }
    ...
    self.AnimateOneEnvironment.sketches[sketchId].running = false;
}
